...
module.exports = {
  ...
  entry: {
    ...
    HealthandEnvironment:['./src/HealthandEnvironment.html','./src/HealthandEnvironment.scss','./src/js/HealthandEnvironment.ts']
  },
  module: {
  ...
  plugins: [
    new BrowserSyncPlugin({
      ...
      publicPath: 'https://berthathings.azurewebsites.net',
